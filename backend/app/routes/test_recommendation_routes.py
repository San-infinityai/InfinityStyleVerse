...
# Recompute TF-IDF only (needed to process new user text input)
...
def recommend():
    try:
        ...
        # Dummy scores for categorical fields (just max per row from precomputed sim matrix)
        ...
        # Handle low relevance (fallback to random)
